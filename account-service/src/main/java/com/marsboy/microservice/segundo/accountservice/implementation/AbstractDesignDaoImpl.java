...
import com.marsboy.microservice.segundo.accountservice.DAO.AbstractDesignDao;
...
public abstract class AbstractDesignDaoImpl<E, I extends Serializable>
        implements AbstractDesignDao<E, I> {
    ...
    public List<E> excuteQuery(Query qry, Class<E> bindResult) {
        ...
        return qry.setResultTransformer(
                new AliasToBeanResultTransformer(bindResult)).list();
    }
